...
public class RecommendedAdapter extends RecyclerView.Adapter<RecommendedAdapter.ViewHolder> {
    ...
    public RecommendedAdapter(FragmentActivity activity, List<RecommendedModel> recommendedModelList) {
    }

    public void RecommendedModel(Context context,List<RecommendedModel> list){
